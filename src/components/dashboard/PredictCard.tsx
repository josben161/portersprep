      ...
      <div className="flex items-center justify-between mb-3">
        <div>
          ...
          <p className="text-xs text-blue-700 dark:text-blue-300">
            Action plan to boost your admission probability
          </p>
        </div>
        <button
          onClick={() => setExpanded(!expanded)}
...
export default function PredictCard() {
  ...
  async function runPredictions() {
    ...
    try {
      ...
      if (result.ok) {
        ...
        alert(
          "Predictions generated successfully! Check the Predict page for detailed results.",
        );
  ...
  return (
    <section className="card p-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="text-sm font-medium text-green-900 dark:text-green-100">
                Overall Admission Probability
              </div>
              <div className="text-xs text-green-700 dark:text-green-300">
                Based on {predictions.length} schools
              </div>
            </div>
            <div className="text-right">
              ...
              <div className="text-xs text-green-700 dark:text-green-300 capitalize">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-3">
            {predictions.slice(0, 3).map((prediction, index) => (
              <SchoolPredictionCard
                key={prediction.school_id || index}
      ...
      {/* Improvement Plan */}
      {improvementPlan && <ImprovementPlanWidget plan={improvementPlan} />}
