        ...
        <div className="mx-auto max-w-6xl px-6 py-20 md:py-28">
          ...
          >
            ...
            <p className="mx-auto mt-5 max-w-2xl text-balance text-base text-muted-foreground md:text-lg">
              From initial assessment to final submission, The Admit Architect provides the tools, insights, and guidance you need to craft compelling MBA applications.
            </p>
