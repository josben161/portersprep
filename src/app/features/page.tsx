...
const features = [
  {
    ...
    description:
      "Get detailed probability analysis for each target school based on your unique profile.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "AI-powered writing environment with real-time feedback and suggestions.",
    benefits: [
  ...
  },
  {
    ...
    title: "Story Bank",
    description:
      "Organize and manage your key experiences for different essay prompts.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Get detailed feedback on your essays with school-specific insights.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Connect with MBA admissions experts for personalized guidance.",
    benefits: [
...
const advancedFeatures = [
  {
    ...
    description:
      "Generate essay outlines and coaching drafts from your story bank.",
  },
  {
    icon: Shield,
        ...
        <div className="mx-auto max-w-6xl px-6 py-20 md:py-28">
          ...
          >
            ...
            <p className="mx-auto mt-5 max-w-2xl text-balance text-base text-muted-foreground md:text-lg">
              From initial assessment to final submission, The Admit Architect
              provides the tools, insights, and guidance you need to craft
              compelling MBA applications.
            </p>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Everything you need to build compelling MBA applications, from
              assessment to submission.
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Premium tools and capabilities for serious applicants who want
              every advantage.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <h2 className="text-3xl font-semibold mb-4">
            Ready to transform your MBA application?
          </h2>
